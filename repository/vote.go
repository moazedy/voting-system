...
type VoteRepo interface {
	// SaveVote saves new vote in database
	SaveVote(ctx context.Context, newVote models.Vote) error
...
func (v *vote) SaveVote(ctx context.Context, newVote models.Vote) error {
